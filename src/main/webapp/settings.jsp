<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <% if(session.getAttribute("user")==null){ response.sendRedirect("login.jsp"); return; } String user=(String)
        ...
        <head>
            <title>Settings | LegalConnect</title>
        ...
        <body>
            ...
            <div class="sidebar">
                ...
                <div class="sidebar-nav">
                    ...
                    <a href="settings.jsp" class="nav-item active"><i
                    ...
                    <div class="settings-card">
                        ...
                        <div class="setting-item">
                            <div class="setting-info">
                                ...
                                <p>Receive emails about your booking status and updates.</p>
                            </div>
                            <label class="switch">
                        ...
                        <div class="setting-item">
                            <div class="setting-info">
                                <h4>SMS Alerts</h4>
                                <p>Get text messages for important reminders.</p>
                            </div>
                            <label class="switch">
                                <input type="checkbox">
                                <span class="slider"></span>
                    ...
                    <div class="settings-card">
                        ...
                        <div class="setting-item">
                            <div class="setting-info">
                                ...
                                <p>Allow lawyers to see your full profile before booking.</p>
                            </div>
                            <label class="switch">
                                <input type="checkbox" checked>
                                <span class="slider"></span>
